...
def main() -> None:
    ...
    for value in VALUES:
        ...
        cfg["output_dir"] = f"outputs/mistral7b_instruct_v03_wmdp_probe_relative_alpha_sweep/alpha/{stem}"
    ...
    for value in VALUES:
        ...
        cfg["unlearn"]["shared_methods"] = []
        cfg["output_dir"] = f"outputs/mistral7b_instruct_v03_wmdp_probe_relative_beta_sweep/beta/{stem}"
    ...
    sweep_output_root = "outputs/mistral7b_instruct_v03_wmdp_probe_relative_main_sweep"
