...
fd, temp_path = tempfile.mkstemp(prefix="llama3_1b_alpha_sweep_", suffix=".yaml")
os.close(fd)
...
case "$MODE" in
  alpha|all)
    run_pattern "configs/llama3_1b_mask_compare_probe_relative_alpha_sweep/alpha/*.yaml"
    ;;
  *)
