...
if "baselines" in unlearn:
    ...
    methods = [objective if wrapper in ("none", None) else f"{wrapper}_{objective}" for wrapper in unlearn.get("wrappers", ["none", "cadmu"])]
completed = set()
...
fd, path = tempfile.mkstemp(prefix="mistral7b_instruct_v03_muse_books_sweep_", suffix=".yaml")
os.close(fd)
...
case "$MODE" in
  alpha) run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_alpha_sweep/alpha/*.yaml" ;;
  beta) run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_beta_sweep/beta/*.yaml" ;;
  activity) run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_main_sweep/activity/*.yaml" ;;
  margin) run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_main_sweep/margin/*.yaml" ;;
  main|stronger)
    run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_main_sweep/activity/*.yaml"
    run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_main_sweep/margin/*.yaml"
    ;;
  all)
    run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_alpha_sweep/alpha/*.yaml"
    run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_beta_sweep/beta/*.yaml"
    run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_main_sweep/activity/*.yaml"
    run_pattern "configs/mistral7b_instruct_v03_muse_books_probe_relative_main_sweep/margin/*.yaml"
    ;;
  *) echo "Usage: $0 [alpha|beta|activity|margin|main|all]" >&2; exit 1 ;;
esac
