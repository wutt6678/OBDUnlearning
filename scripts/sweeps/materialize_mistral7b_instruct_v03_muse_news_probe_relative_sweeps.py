...
BASE_CONFIG = ROOT / "configs/mistral7b_instruct_v03_muse_news_probe_relative_main_sweep.yaml"
...
def main() -> None:
    ...
    for value in VALUES:
        ...
        cfg["output_dir"] = f"outputs/sweeps/mistral7b_instruct_v03/alpha/muse_news_probe_relative_alpha_sweep/alpha/{stem}"
        write(ROOT / "configs/mistral7b_instruct_v03_muse_news_probe_relative_alpha_sweep/alpha" / f"{stem}.yaml", cfg)
    ...
    for value in VALUES:
        ...
        cfg["unlearn"]["shared_methods"] = []
        cfg["output_dir"] = f"outputs/sweeps/mistral7b_instruct_v03/beta/muse_news_probe_relative_beta_sweep/beta/{stem}"
        write(ROOT / "configs/mistral7b_instruct_v03_muse_news_probe_relative_beta_sweep/beta" / f"{stem}.yaml", cfg)

    sweep_config_root = ROOT / "configs/mistral7b_instruct_v03_muse_news_probe_relative_main_sweep"
    sweep_output_root = "outputs/sweeps/mistral7b_instruct_v03/main/muse_news_probe_relative_main_sweep"
