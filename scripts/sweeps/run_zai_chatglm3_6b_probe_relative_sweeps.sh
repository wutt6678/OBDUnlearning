...
fd, path = tempfile.mkstemp(prefix="zai_chatglm3_6b_sweep_", suffix=".yaml")
os.close(fd)
...
case "$MODE" in
  alpha)
    run_pattern "configs/zai_chatglm3_6b_mask_compare_probe_relative_alpha_sweep/alpha/*.yaml"
    ;;
  beta)
    run_pattern "configs/zai_chatglm3_6b_mask_compare_probe_relative_beta_sweep/beta/*.yaml"
    ;;
  activity)
    run_pattern "configs/zai_chatglm3_6b_mask_compare_probe_relative_main_sweep/activity/*.yaml"
    ;;
  margin)
    run_pattern "configs/zai_chatglm3_6b_mask_compare_probe_relative_main_sweep/margin/*.yaml"
    ;;
  stronger)
    run_pattern "configs/zai_chatglm3_6b_mask_compare_probe_relative_main_sweep/activity/*.yaml"
    run_pattern "configs/zai_chatglm3_6b_mask_compare_probe_relative_main_sweep/margin/*.yaml"
