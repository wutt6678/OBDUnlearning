...
BASE_CONFIG = ROOT / "configs/gemma4_e2b_muse_books_probe_relative_main_sweep.yaml"
...
def main() -> None:
    ...
    for value in VALUES:
        ...
        cfg["output_dir"] = f"outputs/sweeps/gemma4_e2b/alpha/muse_books_probe_relative_alpha_sweep/alpha/{stem}"
        write(ROOT / "configs/gemma4_e2b_muse_books_probe_relative_alpha_sweep/alpha" / f"{stem}.yaml", cfg)
    ...
    for value in VALUES:
        ...
        cfg["unlearn"]["shared_methods"] = []
        cfg["output_dir"] = f"outputs/sweeps/gemma4_e2b/beta/muse_books_probe_relative_beta_sweep/beta/{stem}"
        write(ROOT / "configs/gemma4_e2b_muse_books_probe_relative_beta_sweep/beta" / f"{stem}.yaml", cfg)

    sweep_config_root = ROOT / "configs/gemma4_e2b_muse_books_probe_relative_main_sweep"
    sweep_output_root = "outputs/sweeps/gemma4_e2b/main/muse_books_probe_relative_main_sweep"
