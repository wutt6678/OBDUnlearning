...
def main() -> None:
    ...
    for value in VALUES:
        ...
        cfg["output_dir"] = (
            f"outputs/smollm3_3b_mask_compare_probe_relative_alpha_sweep/alpha/{stem}"
        )
        write(
    ...
    for value in VALUES:
        ...
        cfg["unlearn"]["shared_methods"] = []
        cfg["output_dir"] = (
            f"outputs/smollm3_3b_mask_compare_probe_relative_beta_sweep/beta/{stem}"
        )
        write(
    ...
    sweep_output_root = "outputs/smollm3_3b_mask_compare_probe_relative_main_sweep"
