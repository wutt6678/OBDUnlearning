...
if "baselines" in unlearn_cfg:
    ...
    objective = unlearn_cfg.get("objective", "npo")
...
case "$MODE" in
  activity)
    run_pattern "configs/llama3_1b_mask_compare_probe_relative_main_sweep_npo_sweep/activity/*.yaml"
    ;;
  margin)
    run_pattern "configs/llama3_1b_mask_compare_probe_relative_main_sweep_npo_sweep/margin/*.yaml"
    ;;
  all)
    run_pattern "configs/llama3_1b_mask_compare_probe_relative_main_sweep_npo_sweep/activity/*.yaml"
    run_pattern "configs/llama3_1b_mask_compare_probe_relative_main_sweep_npo_sweep/margin/*.yaml"
