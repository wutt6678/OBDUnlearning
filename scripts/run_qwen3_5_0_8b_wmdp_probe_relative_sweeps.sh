...
fd, path = tempfile.mkstemp(prefix="qwen3_5_0_8b_wmdp_sweep_", suffix=".yaml")
os.close(fd)
...
case "$MODE" in
  alpha) run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_alpha_sweep/alpha/*.yaml" ;;
  beta) run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_beta_sweep/beta/*.yaml" ;;
  activity) run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_main_sweep/activity/*.yaml" ;;
  margin) run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_main_sweep/margin/*.yaml" ;;
  main|stronger)
    run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_main_sweep/activity/*.yaml"
    run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_main_sweep/margin/*.yaml"
    ;;
  all)
    run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_alpha_sweep/alpha/*.yaml"
    run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_beta_sweep/beta/*.yaml"
    run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_main_sweep/activity/*.yaml"
    run_pattern "configs/qwen3_5_0_8b_wmdp_probe_relative_main_sweep/margin/*.yaml"
    ;;
