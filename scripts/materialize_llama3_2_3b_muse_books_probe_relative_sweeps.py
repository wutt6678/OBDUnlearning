...
def main() -> None:
    ...
    for value in VALUES:
        ...
        cfg["output_dir"] = f"outputs/llama3_2_3b_muse_books_probe_relative_alpha_sweep/alpha/{stem}"
    ...
    for value in VALUES:
        ...
        cfg["unlearn"]["shared_methods"] = []
        cfg["output_dir"] = f"outputs/llama3_2_3b_muse_books_probe_relative_beta_sweep/beta/{stem}"
    ...
    sweep_output_root = "outputs/llama3_2_3b_muse_books_probe_relative_main_sweep"
