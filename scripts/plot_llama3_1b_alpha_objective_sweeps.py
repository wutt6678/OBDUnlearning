...
PLOT_ROOT = ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps" / "plots"
OBJECTIVE_ROOTS = {
    "grad_diff": ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/grad_diff_alpha_sweep",
    "grad_ascent": ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/grad_ascent_alpha_sweep",
    "npo": ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/npo_alpha_sweep",
    "dpo": ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/dpo_alpha_sweep",
    "simnpo": ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/simnpo_alpha_sweep",
    "rmu": ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/rmu_alpha_sweep",
    "kl": ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/kl_alpha_sweep",
    "retrain": ROOT / "outputs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/retrain_alpha_sweep",
}
WRAPPERS = [
    ("none", "no_mask"),
