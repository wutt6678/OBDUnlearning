...
def main() -> None:
    ...
    plot(
        ROOT / "outputs/llama3_8b_mask_compare_probe_relative_alpha_sweep",
        "alpha",
        "alpha_",
        "alpha_forget",
        full_methods,
    ...
    plot(
        ROOT / "outputs/llama3_8b_mask_compare_probe_relative_beta_sweep",
        "beta",
        "beta_",
        "beta_retain",
        full_methods,
    )
    stronger = ROOT / "outputs/llama3_8b_mask_compare_probe_relative_main_sweep"
    plot(stronger, "activity", "activity_q_", "activity_quantile", full_methods)
    plot(stronger, "margin", "margin_q_", "margin_quantile", full_methods)
