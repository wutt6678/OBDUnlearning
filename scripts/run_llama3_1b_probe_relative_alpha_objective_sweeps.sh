...
fd, temp_path = tempfile.mkstemp(prefix="llama3_1b_alpha_objective_sweep_", suffix=".yaml")
os.close(fd)
...
run_objective() {
  local objective="$1"
  run_pattern "configs/llama3_1b_mask_compare_probe_relative_alpha_objective_sweeps/${objective}_alpha_sweep/alpha/*.yaml"
}
