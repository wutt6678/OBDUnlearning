...
if __name__ == "__main__":
    root = ROOT / "outputs/sweeps/ministral3_3b_instruct/beta/muse_books_probe_relative_beta_sweep"
    title = "ministral3 3b instruct muse books probe-relative beta sweep"
    benchmark = "muse"
    for group in ["beta"]:
        if group == "alpha":
