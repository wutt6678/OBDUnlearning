...
if __name__ == "__main__":
    root = ROOT / "outputs/sweeps/mistral7b_instruct_v03/beta/muse_books_probe_relative_beta_sweep"
    title = "mistral7b instruct v03 muse books probe-relative beta sweep"
    benchmark = "muse"
    for group in ["beta"]:
        if group == "alpha":
