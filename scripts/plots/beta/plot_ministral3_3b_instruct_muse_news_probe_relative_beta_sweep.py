...
if __name__ == "__main__":
    root = ROOT / "outputs/sweeps/ministral3_3b_instruct/beta/muse_news_probe_relative_beta_sweep"
    title = "ministral3 3b instruct muse news probe-relative beta sweep"
    benchmark = "muse"
    for group in ["beta"]:
        if group == "alpha":
