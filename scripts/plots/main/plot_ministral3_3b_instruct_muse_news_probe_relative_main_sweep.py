...
if __name__ == "__main__":
    root = ROOT / "outputs/sweeps/ministral3_3b_instruct/main/muse_news_probe_relative_main_sweep"
    title = "ministral3 3b instruct muse news probe-relative main sweep"
    benchmark = "muse"
