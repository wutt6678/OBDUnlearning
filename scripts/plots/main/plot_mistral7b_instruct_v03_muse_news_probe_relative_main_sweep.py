...
if __name__ == "__main__":
    root = ROOT / "outputs/sweeps/mistral7b_instruct_v03/main/muse_news_probe_relative_main_sweep"
    title = "mistral7b instruct v03 muse news probe-relative main sweep"
    benchmark = "muse"
