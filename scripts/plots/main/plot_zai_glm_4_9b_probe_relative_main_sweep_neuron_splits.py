...
SWEEP_ROOT = ROOT / "outputs/sweeps/zai_glm_4_9b/main/mask_compare_probe_relative_main_sweep"
...
def main() -> None:
    ...
    for group, pattern, x_label in GROUPS:
        ...
        ax.set_title(f"GLM-4-9B probe-relative main_sweep: {group} neuron split ratios")
