...
SWEEP_ROOT = ROOT / "outputs/sweeps/qwen3_5_2b/main/mask_compare_probe_relative_main_sweep"
...
def main() -> None:
    ...
    for group, pattern, x_label in GROUPS:
        ...
        ax.set_title(f"Qwen3.5-2B probe-relative main_sweep: {group} neuron split ratios")
