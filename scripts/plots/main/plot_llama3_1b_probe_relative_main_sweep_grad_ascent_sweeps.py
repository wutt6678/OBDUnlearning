...
SWEEP_ROOT = (
    ROOT
    / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_grad_ascent_sweep"
)
PLOT_DIR = SWEEP_ROOT / "plots"

METHODS = [
    ("grad_ascent", "grad_ascent"),
    ("forget_only_grad_ascent", "forget_only_grad_ascent"),
    ("cadmu_grad_ascent", "cadmu_grad_ascent"),
]
FIGURES = [
...
COLORS = {
    "grad_ascent": "#1f77b4",
    "forget_only_grad_ascent": "#2ca02c",
    "cadmu_grad_ascent": "#9467bd",
}
...
def main() -> None:
    ...
    for group, pattern, x_label in FIGURES:
        ...
        fig.suptitle(
            f"Llama3-1B probe-relative main_sweep grad_ascent: {group}",
            y=1.02,
        )
