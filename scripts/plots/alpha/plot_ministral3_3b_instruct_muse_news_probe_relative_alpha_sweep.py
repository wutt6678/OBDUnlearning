...
if __name__ == "__main__":
    root = ROOT / "outputs/sweeps/ministral3_3b_instruct/alpha/muse_news_probe_relative_alpha_sweep"
    title = "ministral3 3b instruct muse news probe-relative alpha sweep"
    benchmark = "muse"
    for group in ["alpha"]:
        if group == "alpha":
