...
if __name__ == "__main__":
    root = ROOT / "outputs/sweeps/mistral7b_instruct_v03/alpha/muse_news_probe_relative_alpha_sweep"
    title = "mistral7b instruct v03 muse news probe-relative alpha sweep"
    benchmark = "muse"
    for group in ["alpha"]:
        if group == "alpha":
