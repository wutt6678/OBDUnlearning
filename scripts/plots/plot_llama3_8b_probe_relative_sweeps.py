...
def main() -> None:
    ...
    plot(
        ROOT / "outputs/sweeps/llama3_8b/beta/mask_compare_probe_relative_beta_sweep",
        "beta",
        "beta_",
        "beta_retain",
        full_methods,
    )
    stronger = ROOT / "outputs/sweeps/llama3_8b/main/mask_compare_probe_relative_main_sweep"
