...
PLOT_DIR = ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_all_methods" / "plots"
DEFAULT_GROUP = "activity"
DEFAULT_RUN = "activity_q_10"

OBJECTIVE_ROOTS = {
    "grad_diff": ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep",
    "grad_ascent": ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_grad_ascent_sweep",
    "npo": ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_npo_sweep",
    "dpo": ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_dpo_sweep",
    "simnpo": ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_simnpo_sweep",
    "rmu": ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_rmu_sweep",
    "kl": ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_kl_sweep",
    "retrain": ROOT / "outputs/sweeps/llama3_1b/main/mask_compare_probe_relative_main_sweep_retrain_sweep",
}
WRAPPERS = [
